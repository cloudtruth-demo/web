    ...
    return (
        <div className="Top-level">
            <div className="App">
                ...
                <p> The following JSON block is fetched directly by the web application from a CloudTruth configuration template</p>
                <ul>
                ...
                <ul>
                    ...
                    <li>Changes to the static configuration will take affect the next time the service is deployed</li>
