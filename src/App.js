                 ...
                 <div className="use-case-block">
                     <div className="use-case-text">
                         ...
                         <ol>
                             ...
                             <li className="use-case-list-text"><a href="#kubapp">Management of applications & service configuration for Kubernetes</a></li>
                         </ol>
                     </div>
                 </div>
                 ...
                 <div className="use-case">
                     ...
                     <div className="kube-block">
                         <div className="kube-text" id="kubapp">
                             <h2>Management of applications & service configuration for Kubernetes</h2>
                             <ul>
